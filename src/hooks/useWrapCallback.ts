import { AVAX, BNB, DEV, Currency, ETHER, WETH, currencyEquals } from '@zeroexchange/sdk'
...
export default function useWrapCallback(
  ...
  return useMemo(() => {
    ...
    if (
      (inputCurrency === ETHER || inputCurrency === AVAX || inputCurrency === BNB || inputCurrency === DEV) &&
      ...
      (outputCurrency === ETHER || outputCurrency === AVAX || outputCurrency === BNB || outputCurrency === DEV)
    ) {
      return {
