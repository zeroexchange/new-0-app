import { AVAX, BNB, DEV, ChainId, Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount } from '@zeroexchange/sdk'
  ...
  return useMemo(
    () =>
      currencies?.map(currency => {
        ...
        if (currency === ETHER || currency === AVAX || currency === BNB || currency === DEV) return ethBalance[account]
        return undefined
      }) ?? [],
